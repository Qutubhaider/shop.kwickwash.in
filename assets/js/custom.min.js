$(document).ready(function () {
    ...
    //---- All Page header bind
    $.get('controls/ctr-header-css.html', function (controls) {
        $('#ctrheadercss').html(controls)
    });

    //---- All Page header bind
    $.get('controls/ctr-header.html', function (controls) {
        $('#ctrheader').html(controls)
    });
    //---- All Page left menu bind
    $.get('controls/ctr-side-menu.html', function (controls) {
        $('#ctrLeftMenu').html(controls);
    ...
    //---- All Page footer bind
    $.get('controls/ctr-footer.html', function (controls) {
    ...
    $(function () {
        ...
        $(function () {
            var i = function () {
                ...
                768 > l ? ($("div.navbar-collapse").addClass("collapse"),
                    i = 100) : $("div.navbar-collapse").removeClass("collapse"),
                    1170 > l ? (e.addClass("content-wrapper"),
                        $(".sidebar-nav, .slimScrollDiv").css("overflow-x", "visible").parent().css("overflow", "visible")) : e.removeClass("content-wrapper"),
                    s -= i,
                    1 > s && (s = 1),
        ...
        function (e, i, l) {
            ...
            e(s).each(function () {
                var i = {
                    ...
                    , n = e(this).children("i");
                s.length || (s = l.children(".panel-heading").nextAll().wrapAll("<div/>").parent().addClass("panel-wrapper"),
                    i = {}),
